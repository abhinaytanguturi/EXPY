...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_3.acceptDrops()
        self.comboBox_3.setEnabled(0)
        ...
        self.checkBox.setGeometry(QtCore.QRect(110, 40, 16, 16))
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(110, 70, 16, 16))
        ...
        self.checkBox_3.setGeometry(QtCore.QRect(110, 100, 16, 16))
        ...
        self.WriteCache.setGeometry(QtCore.QRect(110, 130, 16, 16))
        ...
        self.label_31.setGeometry(QtCore.QRect(140, 130, 181, 21))
        self.label_31.setObjectName(_fromUtf8("label_31"))
        self.label_32 = QtGui.QLabel(self.frame)
        self.label_32.setGeometry(QtCore.QRect(10, 120, 81, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Test Case Selection", None))
        self.comboBox_3.setItemText(0, _translate("MainWindow", "Select All", None))
        self.comboBox_3.setItemText(1, _translate("MainWindow", "Only Failed ", None))

        self.comboBox_3.setItemText(2, _translate("MainWindow", "Only blocked", None))
        self.comboBox_3.setItemText(3, _translate("MainWindow", "Only Failed & Blocked", None))
        ...
        self.label_32.setText(_translate("MainWindow", "WriteCache", None))
