...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("DiNvmeIdCtrlalog", "Drive Inquiry", None))
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("PyTAF")
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(160, 0, 361, 471))
        self.tabWidget_2.setObjectName(_fromUtf8("tabWidget_2"))


        '''
        self.tabWidget.setTabEnabled(0,0)
        '''
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 341, 431))
        self.frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtGui.QFrame.Raised)
        self.frame.setObjectName(_fromUtf8("frame"))
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(90, 230, 61, 31))
        self.pushButton_5.setObjectName(_fromUtf8("pushButton_5"))
        self.pushButton_6 = QtGui.QPushButton(self.frame)
        self.pushButton_6.setGeometry(QtCore.QRect(170, 230, 71, 31))
        self.pushButton_6.setObjectName(_fromUtf8("pushButton_6"))
        self.progressBar = QtGui.QProgressBar(self.frame)
        self.progressBar.setGeometry(QtCore.QRect(70, 310, 171, 16))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName(_fromUtf8("progressBar"))
        ...
        self.frame_4.setGeometry(QtCore.QRect(0, 0, 351, 441))
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(90, 200, 61, 31))
        self.pushButton_9.setObjectName(_fromUtf8("pushButton_9"))
        self.pushButton_10 = QtGui.QPushButton(self.frame_4)
        self.pushButton_10.setGeometry(QtCore.QRect(170, 200, 71, 31))
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 250, 151, 21))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.pushButton = QtGui.QPushButton(self.executionpanel)

        self.pushButton.setGeometry(QtCore.QRect(0, 0, 95, 21))


        self.pushButton.setStyleSheet('background-color:#00FF00;color:#000000;')

	'''
        self.pushButton.setFixedHeight(100)
        self.pushButton.setFixedWidth(100)

        self.region = QtGui.QRegion(QtCore.QRect(self.pushButton.x()+5,self.pushButton.y()+5,90,90),QtGui.QRegion.Ellipse)
        self.pushButton.setMask(self.region)
	...
	'''
        ...
        self.comboBox_4.setGeometry(QtCore.QRect(10, 270, 111, 21))
	...
	'''
        ...
        self.comboBox_3.setGeometry(QtCore.QRect(10, 200, 111, 21))
        self.comboBox_3.setObjectName(_fromUtf8("comboBox_3"))
        self.comboBox_3.addItem(_fromUtf8(""))
        self.comboBox_3.addItem(_fromUtf8(""))
        self.comboBox = QtGui.QComboBox(self.executionpanel)
        self.comboBox.setGeometry(QtCore.QRect(10, 130, 111, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_24.setText(_translate("MainWindow", "List", None))
        self.label_25.setText(_translate("MainWindow", "Nvme List Command", None))
        self.label_26.setText(_translate("MainWindow", "Id-Ctrl", None))
        self.label_27.setText(_translate("MainWindow", "Ctrl Inquiry Command", None))
        '''
        self.label_28.setText(_translate("MainWindow", "Ctrl Inquiry Command", None))
        self.label_29.setText(_translate("MainWindow", "Id-Ctrl", None))
        '''
    ...
    def b3_clicked(self):
        ...
        self.checkBox_7.setStyleSheet("QCheckBox:checked {color:white;background-color:white}")
        self.checkBox_8.setStyleSheet("QCheckBox:checked {color:white;background-color:white}")
